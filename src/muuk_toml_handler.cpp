...
//     Result<TomlHandler> TomlHandler::parse_file(const std::string& file_path) {
...
//     Result<TomlHandler> TomlHandler::parse(const std::string& content) {
//         TomlHandler handler;

//         Try(handler.parse_content(content));

//         try {
//             handler.content_ = tomlpp::toml::parse(content);
...
//     Result<void> TomlHandler::parse_content(const std::string& content) {
...
//     Result<std::reference_wrapper<TomlSection>> TomlHandler::get_section(const std::string& name) {
...
//     std::string TomlHandler::serialize() const {
...
//     bool TomlHandler::has_section(const std::string& name) const {
//         return sections.find(name) != sections.end();
//     }

//     void TomlHandler::set_section(const std::string& name, const tomlpp::toml::table& table) {
//         auto it = sections.find(name);
//         if (it != sections.end()) {
...
//     void TomlHandler::set_section(const std::string& name, const std::vector<tomlpp::toml::table>& tables) {
//         auto it = sections.find(name);
//         if (it != sections.end()) {
//             if (it->second.is_array()) {
...
//     Result<void> TomlHandler::save_section(const std::string& section_name, const std::string& section_content, bool is_array) {
//         try {
//             tomlpp::toml::table parsed_table = tomlpp::toml::parse(section_content);

//             if (is_array) {
//                 if (sections.find(section_name) != sections.end()) {
//                     sections[section_name].as_array().push_back(std::move(parsed_table));
//                 } else {
//                     sections[section_name] = TomlSection(std::vector<tomlpp::toml::table> { std::move(parsed_table) });
...
//     void TomlHandler::serialize_table(const tomlpp::toml::table& table, std::stringstream& output, int indent_level) const {
