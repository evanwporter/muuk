...
namespace muuk {
    ...
    Result<void> validate_muuk_toml(const toml::table& toml_data) {
        SchemaMap schema = SchemaMap {
            { "package", { false, TomlType::Table, std::nullopt, SchemaMap { { "name", { true, TomlType::String, std::nullopt, std::nullopt } }, { "version", { true, TomlType::String, std::nullopt, std::nullopt } }, { "description", { false, TomlType::String, std::nullopt, std::nullopt } }, { "license", { false, TomlType::String, std::nullopt, std::nullopt } }, { "authors", { false, TomlType::Array, std::vector<TomlType> { TomlType::String }, std::nullopt } }, { "repository", { false, TomlType::String, std::nullopt, std::nullopt } }, { "documentation", { false, TomlType::String, std::nullopt, std::nullopt } }, { "homepage", { false, TomlType::String, std::nullopt, std::nullopt } }, { "readme", { false, TomlType::String, std::nullopt, std::nullopt } }, { "keywords", { false, TomlType::Array, std::vector<TomlType> { TomlType::String }, std::nullopt } } } } },
            { "dependencies", { false, TomlType::Table, std::nullopt, SchemaMap { { "*", { false, TomlType::Table, std::nullopt, SchemaMap { { "git", { false, TomlType::String, std::nullopt, std::nullopt } }, { "muuk_path", { false, TomlType::String, std::nullopt, std::nullopt } }, { "version", { true, TomlType::String, std::nullopt, std::nullopt } } } } } } } },
            { "library", { false, TomlType::Table, std::nullopt, SchemaMap { { "include", { false, TomlType::Array, std::vector<TomlType> { TomlType::String }, std::nullopt } }, { "source", { false, TomlType::Array, std::vector<TomlType> { TomlType::String }, std::nullopt } }, { "cflags", { false, TomlType::Array, std::vector<TomlType> { TomlType::String }, std::nullopt } }, { "libflags", { false, TomlType::Array, std::vector<TomlType> { TomlType::String }, std::nullopt } }, { "lflags", { false, TomlType::Array, std::vector<TomlType> { TomlType::String }, std::nullopt } }, { "system_include", { false, TomlType::Array, std::vector<TomlType> { TomlType::String }, std::nullopt } } } } },
            ...
            { "profile", { false, TomlType::Table, std::nullopt, SchemaMap { { "default", { false, TomlType::Boolean, std::nullopt, std::nullopt } }, { "inherits", { false, TomlType::String, std::nullopt, std::nullopt } }, { "cflags", { false, TomlType::Array, std::vector<TomlType> { TomlType::String }, std::nullopt } }, { "lflags", { false, TomlType::Array, std::vector<TomlType> { TomlType::String }, std::nullopt } } } } },
            { "platform", { false, TomlType::Table, std::nullopt, SchemaMap { { "cflags", { false, TomlType::Array, std::vector<TomlType> { TomlType::String }, std::nullopt } }, { "lflags", { false, TomlType::Array, std::vector<TomlType> { TomlType::String }, std::nullopt } } } } },
            { "compiler", { false, TomlType::Table, std::nullopt, SchemaMap { { "cflags", { false, TomlType::Array, std::vector<TomlType> { TomlType::String }, std::nullopt } }, { "lflags", { false, TomlType::Array, std::vector<TomlType> { TomlType::String }, std::nullopt } } } } }
        };
