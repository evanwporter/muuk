...
// #define CREATE_TOML(str) tomlpp::toml::parse("[package]\nname = \"example\"\n" + std::string(str))

// TEST(ValidateMuukTomlTest, ValidToml) {
//     tomlpp::toml::table valid_toml = CREATE_TOML(R"(
//         version = "1.0"
...
//     tomlpp::toml::table invalid_toml = tomlpp::toml::parse(R"([package]
//         version = "1.0"
//     )");
...
//     tomlpp::toml::table invalid_toml = CREATE_TOML(R"(
//         authors = ["Author1", 2]
//     )");
...
// //     tomlpp::toml::table valid_lock_toml = tomlpp::toml::parse(R"(
// //         [[library]]
// //         name = "an_example"
// //         version = "1.2.3"
...
//     tomlpp::toml::table invalid_lock_toml = tomlpp::toml::parse(R"(
//         [[library]]
//         version = "1.2.3"
//     )");
